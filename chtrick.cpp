// "Convex hull trick": data structure that maintains a set of lines y = mx + b and allows querying the minimum value of mx_0 + b over all lines for some given x_0. Very useful in optimizing DP algorithms for partitioning problems. (Brian Bi)
